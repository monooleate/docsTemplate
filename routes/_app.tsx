...
export default define.page(function App({ Component, state, url }: PageProps) {
  return (
    <html lang="en">
      <head>
        <meta charset="utf-8" />
      ...
      <body class="bg-lightBackground text-lightText dark:bg-darkBackground dark:text-darkText">
        <Component />
      </body>
    </html>
  );
